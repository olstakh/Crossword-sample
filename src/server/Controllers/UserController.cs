...
public class UserController : ControllerBase
{
        ...
        [FromHeader(Name = "X-User-Id")] string? userId)
    {
        ...
        _logger.LogInformation("User {UserId} solved puzzle {PuzzleId}", LogSanitizer.SanitizeForLog(userId), LogSanitizer.SanitizeForLog(request.PuzzleId));
        ...
        [FromHeader(Name = "X-User-Id")] string? userId)
    {
        ...
        _logger.LogInformation("User {UserId} forgot {Count} puzzle(s)", LogSanitizer.SanitizeForLog(userId), request.PuzzleIds.Count());
